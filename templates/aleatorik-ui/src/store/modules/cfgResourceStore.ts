...
import { BaseStore, IComboItem, IComboParams } from "mozart-component-wijmo";
import { IResult } from "mozart-component-wijmo/src/store/modules/baseStore";
...
class CfgResourceStore extends BaseStore<ICfgResourceMaster> {
  constructor(module: Mod<ThisType<{}>, any>) {
    super(
      "CfgResourceMaster",
      Entity.entities.CfgResourceMaster!.properties,
      "CfgResourceMaster",
      module,
    );
  }
