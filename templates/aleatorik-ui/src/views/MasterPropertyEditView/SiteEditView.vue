  ...
  <div>
    ...
    <div class="moz-frame-for-outer-control">
      <WjFlexGrid
        ...
        :showMarquee="true"
      >
        <WjFlexGridColumn binding="SITE_ID" header="SITE ID" aggregate="Cnt" />
        <WjFlexGridColumn binding="SITE_TYPE" header="SITE TYPE" />
    ...
    >
      <DxScrollView width="100%" height="100%">
        <DxForm
          ...
          :form-key="formKey"
          :form-data="formData"
          validation-group="validationSite"
        ...
        >
          <DxTabbedItem cssClass="moz-popup-tabs-colored">
            ...
            <DxTab title="Basic Information">
              ...
              <DxItem
                data-field="SITE_TYPE"
                editor-type="dxSelectBox"
                :editor-options="{
                  searchEnabled: true,
                  showClearButton: true,
                  acceptCustomValue: true,
                  items: ['Inhouse', 'supplier'],
                }"
              >
                <DxRequiredRule message="SITE_TYPE is required" />
              </DxItem>
            </DxTab>
...
import { loadTableDatas, loadProperties, loadPropertyValues } from "@/utils/dataUtils";
...
export default class ItemEditView extends Vue {
  public tableName: string = "CFG_SITE_MASTER";
  public propertyTableName: string = "CFG_SITE_PROPERTY_VALUE";
  public categoryID: string = "Site";
  public dataKey: string[] = ["SITE_ID"];
  ...
  public async onSaveData() {
    const valid = ValidationEngine.validateGroup("validationSite");
    if (!valid.isValid) {
