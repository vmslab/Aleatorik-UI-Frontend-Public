  ...
  <div>
    ...
    <div class="moz-frame-for-outer-control">
      ...
      >
        ...
        <WjFlexGridColumn binding="ITEM_TYPE" header="ITEM TYPE" />
    ...
    >
      <DxScrollView width="100%" height="100%">
        <DxForm
          ...
          :form-key="formKey"
          :form-data="formData"
          validation-group="validationItem"
        ...
        >
          <DxTabbedItem cssClass="moz-popup-tabs-colored">
            ...
            <DxTab title="Basic Information">
              ...
              >
                <DxRequiredRule message="ITEM_TYPE is required" />
              </DxItem>
              <DxItem data-field="#Grade">
                <DxLabel text="Grade" />
              </DxItem>
            </DxTab>
...
export default class ItemEditView extends Vue {
  public tableName: string = "CFG_ITEM_MASTER";
  public propertyTableName: string = "CFG_ITEM_PROPERTY_VALUE";
  public categoryID: string = "Item";
  public dataKey: string[] = ["ITEM_ID"];
  ...
  public async onSaveData() {
    try {
      ...
      const valid = ValidationEngine.validateGroup("validationItem");
      if (!valid.isValid) {
