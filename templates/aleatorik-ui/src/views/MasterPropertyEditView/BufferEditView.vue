  ...
  <div>
    ...
    <div class="moz-frame-for-outer-control">
      <WjFlexGrid
        ...
        :showMarquee="true"
      >
        <WjFlexGridColumn binding="STAGE_ID" header="STAGE ID" aggregate="Cnt" />
        <WjFlexGridColumn binding="BUFFER_ID" header="BUFFER ID" />
        <WjFlexGridColumn binding="SEQUENCE" header="SEQUENCE" />
    ...
    >
      <DxScrollView width="100%" height="100%">
        <DxForm
          ...
          :form-key="formKey"
          :form-data="formData"
          validation-group="validationBuffer"
        ...
        >
          <DxTabbedItem cssClass="moz-popup-tabs-colored">
            ...
            <DxTab title="Basic Information">
              ...
              >
                <DxRequiredRule message="SEQUENCE is required" />
              </DxItem>
              <DxItem
                data-field="#PrebuildDays"
                editor-type="dxNumberBox"
                :editor-options="{
                  showSpinButtons: true,
                  format: ',##0.#########',
                  value: formData['#PrebuildDays'],
                }"
              >
                <DxLabel text="Pre-build Days" />
              </DxItem>
              <DxItem
              ...
              >
                <DxLabel text="Shipping Location" />
              </DxItem>
            </DxTab>
...
export default class BufferEditView extends Vue {
  public tableName: string = "CFG_BUFFER_MASTER";
  public propertyTableName: string = "CFG_BUFFER_PROPERTY_VALUE";
  public categoryID: string = "Buffer";
  public dataKey: string[] = ["BUFFER_ID"];
  ...
  public async stageLoadFunc(obj: ActionLoadOptions) {
  ...
  public onExporting(e: any) {
    e.fileName = `${this.tableName}_${new Date().toDateString()}`;
  }
  ...
  public async onSaveData() {
    try {
      ...
      const valid = ValidationEngine.validateGroup("validationBuffer");
      if (!valid.isValid) {
