  ...
  <div>
    ...
    <div class="moz-frame-for-outer-control">
      <WjFlexGrid
        ...
        :showMarquee="true"
      >
        <WjFlexGridColumn binding="CUSTOMER_ID" header="CUSTOMER ID" aggregate="Cnt" />
        <WjFlexGridColumn binding="CUSTOMER_NAME" header="CUSTOMER NAME" />
    ...
    >
      <DxScrollView width="100%" height="100%">
        <DxForm
          ...
          :form-key="formKey"
          :form-data="formData"
          validation-group="validationCustomer"
        ...
        >
          <DxTabbedItem cssClass="moz-popup-tabs-colored">
            ...
            <DxTab title="Basic Information">
              ...
              <DxItem data-field="CUSTOMER_NAME">
              ...
              >
                <DxRequiredRule message="PRIORITY is required" />
              </DxItem>
            </DxTab>
...
export default class CustomerEditView extends Vue {
  public tableName: string = "CFG_CUSTOMER";
  public propertyTableName: string = "CFG_CUSTOMER_PROPERTY_VALUE";
  public categoryID: string = "Customer";
  ...
  public async onSaveData() {
    try {
      ...
      const valid = ValidationEngine.validateGroup("validationCustomer");
      if (!valid.isValid) {
