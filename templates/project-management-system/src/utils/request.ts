...
let monitoringSocketURL: string | undefined = process.env!.VUE_APP_MONITOR_SOCKET;
export const getMonitoringSocketURL = async (): Promise<string> => {
