<template>
  ...
  <div class="moz-frame-for-outer-control">
    ...
    >
      <WjFlexGridColumn :width="200" binding="allocGroupID" :header="$t('allocGroupID')" :isRequired="true" />
      <WjFlexGridColumn :width="200" binding="sequence" :header="$t('sequence')" />
      <WjFlexGridColumn :width="200" binding="allocType" :header="$t('allocType')" />
      <WjFlexGridColumn
        :width="150"
        binding="createTime"
        :header="$t('CreateTime')"
